...
var Crowller = /** @class */ (function () {
    function Crowller() {
        this.url = 'https://www.huya.com/g/3203';
        this.initSpiderProcess().then();
    }
    Crowller.prototype.getRewHtml = function () {
     ...
     * @param {string} html
     */
    Crowller.prototype.getLiveInfo = function (html) {
        var data = [];
        var $ = cheerio_1.default.load(html);
        var gameLiveItem = $('.game-live-item');
        gameLiveItem.each(function (index, element) {
            data.push({
    ...
    Crowller.prototype.initSpiderProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRewHtml()];
                    case 1:
                        htmlText = _a.sent();
                        return [2 /*return*/, this.getLiveInfo(htmlText)];
                }
            });
        });
    };
    Crowller.getData = function () {
        return new Crowller().initSpiderProcess();
    };
    return Crowller;
}());
exports.default = Crowller;
Crowller.getData().then(function (result) {
    console.log(result);
});
